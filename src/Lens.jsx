    ...
    return (
      <div className='introContentPhoto'>
          ...
          <div className="contentBlock intro">
            ...
            <br/>
            <br/>
            For clarification, photos here of myself that I ask others to take for me are indeed mine, for I would have already set up my camera settings and photo composition prior to having someone else handle the camera and I handle all of the post-production.
            </div>
          </div>
